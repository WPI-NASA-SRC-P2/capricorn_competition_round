...
if __name__=="__main__":
    ...
    rospy.init_node(robot_name + '_teleop_twist_keyboard')
    speed = rospy.get_param("~speed", 1.0)
    turn = rospy.get_param("~turn", 1.0)
    repeat = rospy.get_param("~repeat_rate", 0.0)
    key_timeout = rospy.get_param("~key_timeout", 0.0)

    print("Making Dataset for object detection")
        ...
        while(1):
            ...
            if key in moveBindings.keys():
                ...
                if (status == 14):
                    print(msg)
                status = (status + 1) % 15
            elif key == ' ' and cv_image is not None:
                ...
                print("Not subscribed to image topic yet")
