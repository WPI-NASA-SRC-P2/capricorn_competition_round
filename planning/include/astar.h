...
public:
    ...
    */
    ...
    static std::vector<geometry_msgs::Point> FindPath(std::vector<geometry_msgs::Point> &frontiers, std::vector<geometry_msgs::Point> &obstacles, geometry_msgs::Point target, geometry_msgs::Point start, bool DirectToDest);
};