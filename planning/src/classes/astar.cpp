...
std::array<int, 8> get_neighbors_indicies_array(int pt, int widthOfGrid, int sizeOfGrid) { // maybe use static array instead
...
Path AStar::FindPathOccGrid(nav_msgs::OccupancyGrid oGrid, Point target, Point start) {
    ...
    while(!open_set.empty()) {
        ...
        if(oGrid.data[current.second] >= 50) continue;
