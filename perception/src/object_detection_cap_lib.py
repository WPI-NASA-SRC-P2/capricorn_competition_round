...
def preProcessObjectDetection(category_index, scores, classes, num_detections, final_list) -> None:
    """
...
def detectionAlgorithm(category_index, model_fn, image, disparity, img_pub, disp_pub, robot_name):
    ...
    final_list = []
    preProcessObjectDetection(category_index, scores, classes, num_detections, final_list)
    ...
    for i in final_list:
        ...
        result = estimate3dLocation(category_index, i, boxes[i], classes[i], scores[i], disp_img)
